...
class KMeansPrototypicalPostprocessor(BasePostprocessor):
    def __init__(self, config):
        super(KMeansPrototypicalPostprocessor, self).__init__(config)
    ...
    def perform_classification(self):
        ...
        refined_prototypes.extend(self.refine_group_prototypes(aug_embs[:2]))
        refined_prototypes.extend(self.refine_group_prototypes(aug_embs[2:]))
