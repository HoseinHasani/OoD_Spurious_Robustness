...
normalizer = lambda x: x / (np.linalg.norm(x, axis=-1, keepdims=True) + 1e-6)
    ...
    def inference(self,
        ...
        for loader_name, data_loader in data_loaders_dict.items():
            for batch in tqdm(data_loader,
                ...
                # pred, conf = self.postprocess(net, data, only_feature, model_name)
