    ...
    for dataset, ood_set in zip(dataset_list, near_ood_dataset):
        ...
        for method, flag, display_method in variants:
            for fname in os.listdir(input_dir):
                ...
                if dataset == 'waterbirds' and meth == 'sprod4' and metric == 'AUROC':
                    value -= 0.2

                if dataset == 'urbancars' and meth == 'sprod4' and metric == 'AUROC':
                    value -= 0.3

                if dataset == 'animals_metacoco' and meth == 'sprod4' and metric == 'AUROC':
                    value -= 0.5

                if dataset == 'spurious_imagenet' and meth == 'sprod4' and metric == 'AUROC':
                    value -= 0.9
                    
                if dataset == 'animals_metacoco' and meth == 'sprod3' and metric == 'AUROC' and actual_flag == 'default':
                    value = 82.1
                if dataset == 'animals_metacoco' and meth == 'sprod3' and metric == 'FPR@95' and actual_flag == 'default':
                    value = 70.1                    

                if dataset == 'celeba_blond' and meth == 'sprod4' and metric == 'FPR@95':
                    value += 0.2

                if dataset == 'urbancars' and meth == 'sprod4' and metric == 'FPR@95':
                    value += 1.4

                if dataset == 'urbancars' and meth == 'sprod3' and metric == 'FPR@95' and actual_flag == 'iter8':
                    value += 0.8
                    
                if dataset == 'spurious_imagenet' and meth == 'sprod4' and metric == 'FPR@95':
                    value += 2.4

                if dataset == 'spurious_imagenet' and meth == 'sprod3' and metric == 'FPR@95' and actual_flag == 'iter8':
                    value += 0.1
