...
col_attr_1st = "Train Dataset"  # Primary column attribute
col_attr_2nd = "OOD Dataset"  # Can be None
col_attr_3rd = "Metric"  # Can be None


fixed_attrs = {
    # "OOD Dataset": "SP-OOD",  # Fixed attribute example
}

######################################

csv_file = "softmax.csv"  # Path to your CSV file
