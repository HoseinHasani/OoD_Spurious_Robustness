...
grouped_embs00 = np.load(data_path + 'embs.npy', allow_pickle=True).item()

ood_embs0 = {}
ood_embs0['0'] = grouped_embs00['m']
ood_embs0['1'] = grouped_embs00['m']

grouped_embs0 = {name: grouped_embs00[name] for name in group_names}
grouped_embs_train0 = {name: grouped_embs0[name] for name in group_names}
