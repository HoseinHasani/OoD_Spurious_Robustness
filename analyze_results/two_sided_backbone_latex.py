...
\begin{{table}}[t]
\centering
\caption{{Performance on OOD detection benchmarks using {selected_backbone.replace('_', ' ')}.}}
\label{{tab:backbone_{selected_backbone}}}
...
# Save to file
output_path = os.path.join(output_dir, f"ood_combined_table_{selected_backbone}.tex")
