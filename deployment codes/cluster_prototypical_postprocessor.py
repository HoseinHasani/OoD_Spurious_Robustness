...
class ClusterPrototypicalPostprocessor(BasePostprocessor):
    def __init__(self, config):
        super(ClusterPrototypicalPostprocessor, self).__init__(config)
    ...
    def cluster_group_prototypes(self, group_embs, n_iter=160):
        n_c = len(group_embs)
        ...
        for l in range(n_c):
            ...
            for j in range(n_c):
                ...
                if len(class_prototypes) > 1:
                    refined_prototypes = self.cluster_group_prototypes(class_embs)
