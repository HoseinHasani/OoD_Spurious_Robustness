...
for selected_backbone in backbone_names:
    ...
    \begin{{table}}[t]
    \centering
    \caption{{Far OOD. Backbone: {bb_name.replace('_', ' ')}, AUROC and FPR.}}
    ...
    # Save to file
    output_path = os.path.join(output_dir, f"{bb_name}_AUROC.tex")
