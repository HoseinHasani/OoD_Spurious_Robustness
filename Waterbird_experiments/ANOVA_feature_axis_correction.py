...
def std_ratio(name1, name2, name3, name4, eps=1e-6, n_select=600):
    ...
    ratio = std_all / (std1 + std2 + eps)
    
    plt.figure()
    plt.hist(ratio, 100)
    
    sorted_args = np.argsort(ratio)
...
core_ax1 = std(core_class_names[0], sp_class_names[0], core_class_names[0], sp_class_names[1])
core_ax2 = std(core_class_names[1], sp_class_names[0], core_class_names[1], sp_class_names[1])

sp_ax1 = std(core_class_names[0], sp_class_names[0], core_class_names[1], sp_class_names[0])
sp_ax2 = std(core_class_names[0], sp_class_names[1], core_class_names[1], sp_class_names[1])

#core_ax1 = std_ratio(core_class_names[0], sp_class_names[0], core_class_names[0], sp_class_names[1])
#core_ax2 = std_ratio(core_class_names[1], sp_class_names[0], core_class_names[1], sp_class_names[1])
#
#sp_ax1 = std_ratio(core_class_names[0], sp_class_names[0], core_class_names[1], sp_class_names[0], n_select=20)
#sp_ax2 = std_ratio(core_class_names[0], sp_class_names[1], core_class_names[1], sp_class_names[1], n_select=20)
