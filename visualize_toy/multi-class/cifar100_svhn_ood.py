...
data = np.load("cifar100_resnet50_embeddings.npy")  # (100, N, 2048)
svhn_data = np.load("svhn.npy")  # shape: (1000, 2048)
...
for K in Ks:
    ...
    for seed in seeds:
        ...
        X_ood = svhn_data[start_idx:end_idx]
        ...
        for cls in test_classes:
            samples = data[cls][200:250]  # 50 samples per test class
